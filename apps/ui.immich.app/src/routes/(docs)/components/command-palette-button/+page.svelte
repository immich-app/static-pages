...
<ComponentPage name="CommandPaletteButton" description="A dedicated button to open the command palette">
  <ComponentTipCard>
    <Text>See <ComponentLink name="CommandPalette" /> for more information</Text>
  </ComponentTipCard>
