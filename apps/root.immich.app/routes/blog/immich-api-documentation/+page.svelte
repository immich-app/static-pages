...
<BlogPage post={Posts.ImmichApi}>
  ...
  <Text
    ...
    for an application, integration, tool, or client that integrates with Immich, this is the place for you.</Text
  >
  ...
  <Text
    >If you have any feedback or questions about the new site, feel free to reach out to us on <Link
      href={Constants.Socials.Discord}>Discord</Link
    >, <Link href={Constants.Socials.Reddit}>reddit</Link>, or <Link href={Constants.Socials.Github}>GitHub</Link
    >.</Text
  >
</BlogPage>
