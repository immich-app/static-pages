...
:::info
It is important to note that we hold registered trademarks for the brand "Immich", including the logo. For more information about using our name and brand, see our [Frequently Asked Questions](https://docs.immich.app/FAQ#commercial-guidelines).
...
- [Donate to projects](https://futo.tech/blog/dont-be-evil-conference-2026) that Immich relies on, such as [libvips](https://www.libvips.org/), [exiftool](https://exiftool.org/), [ffmpeg](https://www.ffmpeg.org/), and many more
- Launch our [merch store](https://immich.store/)
